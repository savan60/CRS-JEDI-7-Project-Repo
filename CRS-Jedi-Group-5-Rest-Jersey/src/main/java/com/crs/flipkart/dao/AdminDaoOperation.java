...
public class AdminDaoOperation implements AdminDaoInterface {
	...
	public boolean addProfessorToDB(Professor professor) throws UserAlreadyExistsException{
		...
		logger.info("addProfessorToDB method started");
...
//			System.out.println(profQueryRes);
	...
	/**
	 * 
	 * Method to facilitate approval of students by admin
	 * 
	 * @param count, defines mode of operation
	 * @throws NoStudentApprovalException
	 * 
	 * 
	 */
