...
public class PaymentDaoOperation implements PaymentDaoInterface {
	 ...
	 * 
	 * 
	 * Initialize database for storing Invoice for fee payment
	 */
	 ...
	 *  @return boolean true if data updated successfully else false
	 */
	public boolean generatePaymentDetailsForAllStudents(int amount, String message) throws NegativeAmountException{
		logger.info("generatePaymentDetailsForAllStudents method started");
	 ...
	 *  
	 *  @return boolean true if successfull updation, else false
	 */
	public boolean updatePaymentDetails(String studentId, String paymentType) throws StudentNotFound{
		logger.info("updatePaymentDetails method started");
	...
	/**
	 * Get list of payments made by student with studentId
	 * 
	 * @param userId 
	 * @return boolean true if list fetched successfully, else zero 
	 */
	@Override
